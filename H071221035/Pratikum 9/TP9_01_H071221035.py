class Human :
    def __init__(self,name,pos_x) :
        self.nama = name #publik
        self.__posisi = pos_x #private
        self._speed = 1 #protected
...
class Hero (Human):
    ...
    def attack (self,target) : #target = objek dari luar jadi untuk aksesnya itu harus pake setter getter
...
class Warrior (Hero) :
    ...
    def special (self,target) :
        self._armor = 45
        self._power = 32
        self.attack(target) #fungsi sama jadi tak perlu buat ulang jdi lebih baik digunakan yg sudah ada
...
#objek
warrior = Warrior("megawati", pos_x=10)
assassin = Assassin("jokowi", pos_x=25)
support = Support("maaruf amin",pos_x=30)
...
print("support (health) : ",support.getHealth())
